...
function showAuthView() {
  ...
  statusEl.textContent = "Log in to use Cheatly";
...
function showMainView(email, subInfo) {
  ...
  if (subInfo && subInfo.subscribed) {
    if (subInfo.trial) {
      subBadge.textContent = "Free Trial";
      subBadge.className = "sub-badge trial";
    } else {
      subBadge.textContent = "Active";
      subBadge.className = "sub-badge active";
    }
    subDetail.textContent = subInfo.plan || "Cheatly Pro";
    ...
    subDetail.textContent = "Subscribe to start answering questions";
    subscribeCta.classList.remove("hidden");
    settingsSection.classList.add("hidden");
    toggleWrap.style.display = "none";
    shortcutHint.style.display = "none";
    statusEl.textContent = "Subscribe to unlock Cheatly";
    statusEl.className = "status";
  }
}
...
async function loadAuthState() {
  ...
  showMainView(authEmail, subInfo);
